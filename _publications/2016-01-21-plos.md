...
excerpt: 'We examine the hypothesis that driven by a competition heuristic, people do not even reflect or consider whether a cooperation strategy may be better (zero-sum game fallacy). We demonstrate that people only cooperate if the competitive heuristic is explicitly overridden.'
date: 2016-01-21
venue: 'PLoS ONE'
